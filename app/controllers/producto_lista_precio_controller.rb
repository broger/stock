class ProductoListaPrecioController < ApplicationController
  # GET /producto_lista_precio
  # GET /producto_lista_precio.xml
  def index
    @producto_lista_precio = ProductoListaPrecio.all
  ...
  # GET /producto_lista_precio/1
  # GET /producto_lista_precio/1.xml
  def show
  ...
  # GET /producto_lista_precio/new
  # GET /producto_lista_precio/new.xml
  def new
  ...
  # GET /producto_lista_precio/1/edit
  def edit
    @producto_lista_precio = ProductoListaPrecio.find(params[:id])
  end

  # POST /producto_lista_precio
  # POST /producto_lista_precio.xml
  def create
  ...
  # PUT /producto_lista_precio/1
  # PUT /producto_lista_precio/1.xml
  def update
    @producto_lista_precio = ProductoListaPrecio.find(params[:id])
  ...
  # DELETE /producto_lista_precio/1
  # DELETE /producto_lista_precio/1.xml
  def destroy
    @producto_lista_precio = ProductoListaPrecio.find(params[:id])
    @producto_lista_precio.destroy

    respond_to do |format|
      format.html { redirect_to(producto_lista_precio_url) }
      format.xml  { head :ok }
    end
  end
end
